...
#define MKZ_GENERIC_ID_EMPTY 0
#define MKZ_GENERIC_ID_MESH 1
#define MKZ_GENERIC_ID_LIGHT 2
#define MKZ_GENERIC_ID_CAMERA 3
#define MKZ_GENERIC_ID_OBJECT 4
#define MKZ_GENERIC_ID_MATRIX 5

#define MKZ_GENERIC_ID_UNDEFINED -1
#endif
