...
/** MESH **/
MKZ_geometry * MKZ_GEOMETRY_create_geometry(MKZ_point3 * vertices, MKZ_face * faces , int vertex_count , int face_count){

	MKZ_geometry * mesh = (MKZ_geometry*) malloc(sizeof(MKZ_geometry));
...
MKZ_geometry * MKZ_GEOMETRY_load_geometry(char * file_name){
	...
	MKZ_geometry * mesh = 0;
	if (error == 0)
		mesh = MKZ_GEOMETRY_create_geometry(p3, fc, vertex_count, face_count);
...
void MKZ_GEOMETRY_free_geometry(MKZ_geometry * mesh){
